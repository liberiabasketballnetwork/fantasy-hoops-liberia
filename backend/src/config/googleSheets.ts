...
export const SHEET_HEADERS: Record<string, string[]> = {
  ...
  [SHEET_NAMES.CAMPAIGNS]: ["campaign_id","title","subject","message","notification_type","audience_type","audience_filter","status","recipient_count","scheduled_at","sent_at","created_by","created_at","link","priority","delivery_duration_ms","channels","delivery_results","whatsapp_queue_status","sponsor_id"],
  ...
  [SHEET_NAMES.PRIZE_PAYOUTS]: ["payout_id","week_id","reward_source_id","source_type","recipient_user_id","sponsor_id","amount_lrd","currency","status","admin_notes","payment_reference","reversal_of","created_at","created_by","reviewed_at","reviewed_by","paid_at","completed_at"],
  ...
  [SHEET_NAMES.GAMEWEEK]: ["week_id","start_date","end_date","submission_deadline","is_locked","scores_calculated","prices_updated","created_at","sponsor_id"],
  ...
  [SHEET_NAMES.SPONSORS]: ["sponsor_id","company_name","logo_url","website","contact_name","contact_phone","contact_email","tier","contract_start","contract_end","status","notes","created_at","created_by"],
